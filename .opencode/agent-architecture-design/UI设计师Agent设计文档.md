...
**并行工作模式**：与产品经理同时工作，都基于用户需求独立产出。

```
用户需求
    │
    ├──→ product-manager → PRD（功能定义）
    │
    └──→ ui-designer → 设计规范（视觉定义）
```
...
关键词从**用户需求**中提取，包含：产品类型、行业、风格关键词。例如：
...
*文档版本: v2.0*
*最后同步: 2026-04-06*
*更新内容：新增并行工作模式、输出约束（整体风格限制、输出长度控制）*
